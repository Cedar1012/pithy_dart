          ...
          children: [
            Column(
              ...
              children: [
                ...
                SizedBox(height: 8),
                Text('成功', style: TextStyle(fontSize: 14, color: Colors.green)),
              ],
            ),
            Column(
              mainAxisSize: MainAxisSize.min,
              children: [
                ...
                SizedBox(height: 8),
                Text('警告', style: TextStyle(fontSize: 14, color: Colors.orange)),
              ],
            ),
            Column(
              mainAxisSize: MainAxisSize.min,
              children: [
                ...
                SizedBox(height: 8),
                Text('错误', style: TextStyle(fontSize: 14, color: Colors.red)),
              ],
            ),
          ],
        ),
